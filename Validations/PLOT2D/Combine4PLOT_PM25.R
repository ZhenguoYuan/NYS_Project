...
foreach (year = 2002 : 2016) %dopar% {
  # DOY
  numdays <- numOfYear(as.numeric(year))
  # Paths
  inpath <- file.path('/home/jbi6/envi/NYS_Output/MAIAC_GRID_OUTPUT/Modeling/PM25_PRED_RFMODEL', as.character(year))
  outpath <- file.path('/home/jbi6/envi/NYS_Output/MAIAC_GRID_OUTPUT/Validations/PLOT2D/PLOTPM25', as.character(year))
