...
for (year in 2002 : 2016) {
  ...
  #gg_pm25
  # ggsave(filename = file.path('~/Downloads//NYS/', as.character(year), paste(as.character(year), 'PM2.5', '.png', sep = '')), width = 30, height = 30, units = 'cm')
  ggsave(filename = file.path('~/Downloads/NYS_2002_2016/', paste(as.character(year), '_PM2.5', '.png', sep = '')), width = 15, height = 15, units = 'cm')
