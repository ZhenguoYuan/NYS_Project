...
## ---------- RF ---------- ##
# AAOT550 overall
aaot550.combine.cldonly <- aodCombine(year, day.range, inpath, 'aqua550', 'overall')
...
# TAOT550 overall
taot550.combine.cldonly <- aodCombine(year, day.range, inpath, 'terra550', 'overall')
...
## ---------- RF ---------- ##
# AAOT550 overall
aaot550.combine.cldsnw <- aodCombine(year, day.range, inpath, 'aqua550', 'overall')
...
# TAOT550 overall
taot550.combine.cldsnw <- aodCombine(year, day.range, inpath, 'terra550', 'overall')
